...
import showWebDialog from './showWebDialog';
import promptUnsaved from './promptUnsaved';
import menuActionProcessorFactory from './menuActionProcessorFactory';
...
ipcRenderer.on('menu-action', menuActionProcessorFactory(tabs, mainSplit, viewerSplit, settings))